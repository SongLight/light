...
// md5 params:  equtype=ANDROID&loginImei=Androidnull&timeStamp=1646833932226&userPwd=a12345678&username=15968079477&key=sdlkjsdljf0j2fsjk
// md5 retval:  c8df94531f9a5450e16ef03568307f30
...
//     var _plainText = '{"equtype":"ANDROID","loginImei":"Androidnull","sign":"' + sign + '","timeStamp":"' + time + '","userPwd":"' + pwd +'","username":"' + user + '"}';
//     console.log(_plainText);
//
//     var keyMD5 = CryptoJS.MD5("65102933").toString();
//     console.log(keyMD5)
//     var _key = CryptoJS.enc.Hex.parse("c3d26dca86259782bd9186");
...
function getData(user, pwd, time){
...
console.log(CryptoJS.enc.Base64.parse("eGlhb2ppYW5iYW5n").toString(CryptoJS.enc.Utf8));

// console.log(CryptoJS.enc.Hex);
// console.log(CryptoJS.enc.Utf8);
//console.log(getData("5526936996", "fguhg"));

console.log(getData("5526936996", "fguhg", "1655880612498"))
